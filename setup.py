...
MATLAB_DIR= 'C:/Program Files/MATLAB/R2010b'            # e.g: '/usr/local/matlab'; 'c:/matlab6'
...
if WINDOWS:
    if VC_DIR:
        ...
        MATLAB_INCLUDE_DIRS += [VC_DIR + "/include", "C:/Program Files (x86)/Microsoft SDKs/Windows/v7.0A/Include"]
    else:
